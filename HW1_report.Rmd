...
mean(problem_2.1)
median(problem_2.1)
max(problem_2.1) - min(problem_2.1)
sd(problem_2.1)
```
...
hist(problem_2.1)
```
According to the plots, the data of the bike crash is right-skewed and an unimodal distribution.
...
```
According to the plots, the data of the bike crash is right-skewed and an unimodal distribution and the data of the car crash is an unimodal distribution.
...
### b)Let’s define the event Bas “number 10 appears”. What is the probability of the event B?
